...
## ขั้นตอนที่ 4: ตั้งค่ารหัสผ่าน (Environment Variables)

**สำคัญมาก!** ถ้าไม่ทำขั้นตอนนี้ คุณจะเข้าสู่ระบบไม่ได้ เพราะ Vercel ไม่รู้จักไฟล์ `.env` ในเครื่องคุณ

1.  ไปที่ Dashboard ของโปรเจกต์คุณใน [Vercel](https://vercel.com/)
2.  กดที่เมนู **Settings** (ด้านบน)
3.  เลือกเมนู **Environment Variables** (ด้านซ้าย)
4.  เพิ่มตัวแปรทีละตัวดังนี้:

    **ตัวที่ 1 (แอดมิน):**
    *   **Key:** `VITE_ADMIN_PASS`
    *   **Value:** `Suza01Suz@!#` (หรือรหัสที่คุณต้องการ)
    *   กด **Save**

    **ตัวที่ 2 (ผู้ดูทั่วไป):**
    *   **Key:** `VITE_USER_660452_PASS`
    *   **Value:** `660452` (หรือรหัสที่คุณต้องการ)
    *   กด **Save**

5.  หลังจากเพิ่มเสร็จแล้ว ให้ไปที่เมนู **Deployments** แล้วกด **Redeploy** (จุดสามจุดหลังชื่อ Commit ล่าสุด -> Redeploy) เพื่อให้ค่าใหม่เริ่มทำงาน

---

## ขั้นตอนที่ 5: วิธีอัปเดตข้อมูล (Excel/CSV)
